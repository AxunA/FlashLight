...
import com.digital.common_util.AppInfoUtil;
...
public class MainActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    public static final int OPEN_LIGHT = 0x0010; //打开手电
    public static final int CLOSE_LIGHT = 0x0020; //关闭手电
    ...
    private TextView tvVersionInfo;  //版本信息
    ...
    private void initViews() {
        ...
        String version= getString(R.string.version_info)+AppInfoUtil.getVersionName(this);
